...
public PersonneService(){
    ...
    public void ajouter(Personne personne) throws SQLException {
        ...
        String sql =  "insert into personne (nom , prenom , age)"+"values('"+personne.getNom()+"','"+personne.getPernom()+"',"+personne.getAge()+")";
    ...
    String sql = "update personne set nom = ? , prenom = ? , age = ? " +"where id = ? ";
        ...
        preparedStatement.setString(2, personne.getPernom());
    ...
    public List<Personne> recuperer() throws SQLException {
        ...
        while (rs.next()) {
            ...
            p.setPernom(rs.getString("prenom"));
            personnes.add(p);
        }
        return personnes;
    }
    ...
    @Override
    public List<Personne> trier() throws SQLException {
        String sql = "SELECT * FROM personne ORDER BY nom ASC, prenom ASC";
        Statement statement = connection.createStatement();
        ResultSet rs = statement.executeQuery(sql);
        List<Personne> personnes = new ArrayList<>();
        while (rs.next()) {
    ...
    @Override
    public List<Personne> rechercher(String motCle) throws SQLException {
